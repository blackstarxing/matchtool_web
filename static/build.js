...
=======
	...
	var _matchtool = __webpack_require__(44);

	var _matchtool2 = _interopRequireDefault(_matchtool);

	var _createquickmatch = __webpack_require__(46);

	var _createquickmatch2 = _interopRequireDefault(_createquickmatch);

	var _quickmatchformat = __webpack_require__(48);

	var _quickmatchformat2 = _interopRequireDefault(_quickmatchformat);

	var _createLeaguematch = __webpack_require__(45);

	var _createLeaguematch2 = _interopRequireDefault(_createLeaguematch);

	var _landRegister = __webpack_require__(47);
...
>>>>>>> 53a3d210d6a769b02c377d4da65a545237ce0706
			...
			getIdent: function getIdent() {
				...
				this.$http.post('http://172.16.2.63:8088/sendVerifyCode', parm).then(function (response) {
					...
					if (!response.data.code) {
						$('.reg_error').show();
						$('.error_tip').text(response.data.msg);
					}
				}, function (response) {
					console.log(response);
				});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = "\n\t<div class=\"m-sidebar\">\n\t\t<ul>\n\t\t\t<li><a href=\"\"><img src=\"" + __webpack_require__(10) + "\" alt=\"\"></a></li>\n\t\t\t<li><a href=\"\"><img src=\"" + __webpack_require__(11) + "\" alt=\"\"></a></li>\n\t\t\t<li @click=\"showPop\"><a href=\"\"><img src=\"" + __webpack_require__(12) + "\" alt=\"\"></a></li>\n\t\t</ul>\n\t</div>\n";

/***/ },
/* 37 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = "\n\t<div class=\"m-slideInto\">\n\t\t<div class=\"top-logo clearfix\">\n\t\t\t<a href=\"\" class=\"slideout\" @click=\"slideout\"></a>\n\t\t\t<img src=\"" + __webpack_require__(9) + "\" alt=\"\">\n\t\t</div>\n\t\t<ul>\n\t\t\t<li class=\"current\"><a href=\"\"><img src=\"" + __webpack_require__(10) + "\" alt=\"\">首页</a></li>\n\t\t\t<li class=\"arrow\"><a href=\"\"><img src=\"" + __webpack_require__(11) + "\" alt=\"\">申请认证</a></li>\n\t\t\t<li class=\"arrow\" @click=\"showPop\"><a href=\"\"><img src=\"" + __webpack_require__(12) + "\" alt=\"\">创建赛事</a></li>\n\t\t</ul>\n\t</div>\n";
