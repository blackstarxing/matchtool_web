				...
				<div class="m-tb">
					<table class="account_table">
	                    ...
	                    <tr v-for='member in memberlist.list' class="memberInfo">
	                        ...
	                        <td>
	                        	<div class="option">
	                        		<a href="javascript:void(0);" class="u-btn-write" data-id="{{member.id}}" @click="editMember"></a><a href="" class="u-btn-delete" data-id="{{member.id}}" @click="deleteMember" v-if="roundStatus<6"></a>
	                        	</div>
	                        </td>
	                    </tr>
	                    </tbody>
